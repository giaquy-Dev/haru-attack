...
def help():
    ...
    stdout.write("             "+Fore.LIGHTBLUE_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"THANK    "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" Thanks for using HARU.                 "+Fore.LIGHTBLUE_EX+"║\n")
    stdout.write("             "+Fore.LIGHTBLUE_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"YOU♥     "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" Plz star project :)                    "+Fore.LIGHTBLUE_EX+"║\n")
    stdout.write("             "+Fore.LIGHTBLUE_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"github   "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" https://github.com/giaquy-Dev          "+Fore.LIGHTBLUE_EX+"║\n")
    stdout.write("             "+Fore.LIGHTYELLOW_EX          +"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def credit():
...
##############################################################################################
def command():
    stdout.write(Fore.LIGHTBLUE_EX+"╔═══"+Fore.LIGHTYELLOW_EX+"[""root"+Fore.LIGHTRED_EX+"@"+Fore.LIGHTRED_EX+"Haruko"+Fore.YELLOW+"]"+Fore.LIGHTBLUE_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.CYAN)
    command = input()
